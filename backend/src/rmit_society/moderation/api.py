"""Moderation bounded context: HTTP interface (queue, decisions, appeals, audit)."""
...
from rmit_society.moderation.application import ModerationService
...
from rmit_society.shared.enums import AppealState, RiskLevel
from rmit_society.shared.events import AuditEvent

repo = get_repository()
moderation = ModerationService(repo, EngagementService(repo))
