"""Moderation bounded context: application service for review decisions and appeals."""
...
from rmit_society.shared.enums import (
    AppealState,
    ContentState,
    ModerationDecision,
    ReportState,
...
class ModerationService:
    """Coordinates human moderator review, appeals, and audit for community content."""
    ...
    def __init__(
        ...
        self.repo = repo
        self.engagements = engagements or EngagementService(repo)
