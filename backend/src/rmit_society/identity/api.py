"""Identity bounded context: HTTP interface (profile + local auth routers)."""
...
# --------------------------------------------------------------------------- #
# Local development authentication (Cognito-backed)
# --------------------------------------------------------------------------- #
...
@auth_router.post("/confirm", response_model=AuthTokens)
...
@auth_router.post("/sign-in", response_model=AuthTokens)
