...
\includegraphics[width=0.96\textwidth,height=0.82\textheight,keepaspectratio]{figures/figure1-roles.png}
\caption{Product roles and client operations. The diagram orients the reader; the operation coverage table, Figure~\ref{fig:core-flow}, and the detailed sequences in \hyperref[app:detailed-sequences]{Appendix~\ref*{app:detailed-sequences}} provide the downstream invocation paths.}
\label{fig:roles}
\end{figure}
\clearpage
...
\clearpage
\begin{figure}[p]\centering
\includegraphics[width=0.96\textwidth,height=0.84\textheight,keepaspectratio]{figures/figure2-overview.png}
...
\begin{figure}[p]\centering
\includegraphics[width=0.96\textwidth,height=0.84\textheight,keepaspectratio]{figures/figure3-core-flow.png}
...
\clearpage
\begin{figure}[p]\centering
\includegraphics[width=0.96\textwidth,height=0.84\textheight,keepaspectratio]{figures/figure7-erd.png}
\caption{Simplified logical data model. It communicates relationships and invariants rather than every physical column.}
\label{fig:erd}
\end{figure}
\clearpage
...
\section{Detailed operation sequences}\label{app:detailed-sequences}
...
\begin{figure}[p]\centering
\includegraphics[width=0.96\textwidth,height=0.84\textheight,keepaspectratio]{figures/figure4-media-location.png}
\caption{Two-lane media-upload and verified-location flow. The backend controls authorization and persistence; the browser sends media bytes directly to S3 and location data is verified against Mapbox.}
\label{fig:media-location-flow}
\end{figure}
\clearpage

\begin{figure}[p]\centering
\includegraphics[width=0.96\textwidth,height=0.84\textheight,keepaspectratio]{figures/figure5-moderation.png}
\caption{Moderation and optional content-analysis flow. Orange elements are feature-gated; do not claim them as deployed evidence without an end-to-end observation.}
\label{fig:moderation-flow}
\end{figure}
\clearpage

\begin{figure}[p]\centering
\includegraphics[width=0.96\textwidth,height=0.84\textheight,keepaspectratio]{figures/figure6-analytics.png}
\caption{Optional analytics refresh and reporting flow. Dashed arrows represent scheduling and orchestration transitions. The full path must be enabled and observed before it is stated as deployed.}
